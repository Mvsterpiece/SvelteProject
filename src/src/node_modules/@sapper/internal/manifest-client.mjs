...
export const ignore = [/^\/auth\/register\/?$/, /^\/auth\/logout\/?$/, /^\/auth\/login\/?$/, /^\/auth\/app\/?$/, /^\/blog\.json$/, /^\/blog\/([^/]+?)\.json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/logout.svelte")
	},
	{
...
if (typeof window !== 'undefined') {
	import("C:/Users/opilane/source/repos/Svelte/SvelteProject/node_modules/sapper/sapper-dev-client.js").then(client => {
